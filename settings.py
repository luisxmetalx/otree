...
SECRET_KEY = 'd$#*qc5e-fh9t+wd!mys+fa+l2*8s=5l0$5yn7+$waokfhoph+'
...
SESSION_CONFIGS = [
    {
        ...
        'display_name': "Mi primer ejemplo",
        'num_demo_participants': 4,
        'app_sequence': ['my_simple_survey'],
    },
    {
        'name': 'my_public_goods',
        'display_name': "ejemplo con pago a los participantes",
    ...
    {
        'name': 'my_trust',
        'display_name': "ejemplo de esperar a uno del grupo por otro dato",
